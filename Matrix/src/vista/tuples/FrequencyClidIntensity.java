...
//Date: 2005/05/27
//Vers: 1.0
//File: FrequencyClidIntensity.java
...
/** This class implement the Frequency Clid Intensity algorithm.

@author Tahiti.
*/
public class FrequencyClidIntensity implements UpdateMethod{
	 ...
	 *
	 */
	public FrequencyClidIntensity(Entities entities){
   this.entities=entities;
    ...
    public Vector getLocators(){
        ...
        System.out.println("Number of Entitities"+entities.getSize());

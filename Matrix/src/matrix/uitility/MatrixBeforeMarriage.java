 ...
 */
public class MatrixBeforeMarriage extends JPanel{
    ...
    private void drawSpinningBands(Graphics2D g2d, int cx, int cy) {
  	...
  	public static void main(String args[]) {
		...
		JFrame frame = new JFrame("Matrix Before Marriage");
		MatrixBeforeMarriage game = new MatrixBeforeMarriage();

...
public class MatrixAfterMarriage extends JPanel {
    ...
    public static void main(String[] args) {
        SwingUtilities.invokeLater(() -> {
            JFrame frame = new JFrame("Matrix After Marriage");
            MatrixAfterMarriage panel = new MatrixAfterMarriage();

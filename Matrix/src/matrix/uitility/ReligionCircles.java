...
public class ReligionCircles extends JPanel implements java.awt.event.ActionListener {
    ...
    private void drawCenteredString(Graphics2D g2, String text, double centerX, double centerY, int maxWidth) {
        ...
        if (fm.stringWidth(text) > maxWidth) {
            ...
            if (text.contains("Non-Abrahamic")) {
                line1 = "Non-Abrahamic";
                line2 = "Religions";
            } else if (text.contains("Abrahamic")) {
                line1 = "Abrahamic";
                line2 = "Religions";
            } else {
                line1 = text;
    ...
    protected void paintComponent(Graphics g) {
        ...
        drawCenteredString(g2, "Non-Abrahamic Religions", rx, ry, 150);
        drawCenteredString(g2, "Abrahamic Religions", gx, gy, 150);
        drawCenteredString(g2, "Sikhism Religion", bx, by, 150);
    ...
    public static void main(String[] args) {
        SwingUtilities.invokeLater(() -> {
            JFrame f = new JFrame("Religion Circles - Real Matrix");
            f.setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);
            f.add(new ReligionCircles());
            f.pack();

...
import matrix.uitility.MatrixThreadManager;


/*
 * Matrix is simulation of Multiverse. 
 * 
 * Author: Abhijeet Rane or Mahesh son of Shiva. Mahesh takes birth on earth to create a new matrix because of Kalyug the current matrix is in imbalance.
 * He creates a new matrix and transfers all the data from current matrix using the filter provided by Hanuman. Hanuman is a form of Shiva. This happens every 5000 years.
 * 
 * 
 * 
 * 
 ...
 * 10-August-2026 : Meaning of Emotional World(West Matrix) and Inner World(East Matrix)
 */
